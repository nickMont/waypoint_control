...
//	nextWaypoint_(0)=initPose_->pose.pose.position.x;
//	nextWaypoint_(1)=initPose_->pose.pose.position.y;
//	nextWaypoint_(2)=initPose_->pose.pose.position.z+1; //1m above initial pose
}
